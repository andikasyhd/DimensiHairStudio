...
export default function Cek() {
  ...
  const handleSubmit = (e) => {
    ...
    setProduk(found);
    setStatus(found.stok > 0 ? "available" : "empty");
  };

  return (
    <div className="max-w-xl mx-auto py-10 px-6 bg-white shadow-xl rounded-2xl mt-12 mb-12 border border-red-100">
      {/* Header */}
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold mb-2 text-red-600 flex items-center justify-center gap-2">
          <FaSearch /> Cek Ketersediaan Produk
        </h2>
        <p className="text-gray-600">Masukkan kode produk seperti <strong>P001</strong> untuk melihat info</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="mb-6">
        <div className="relative mb-4">
          <input
            ...
            className="w-full p-4 pl-12 border-2 border-gray-200 rounded-xl focus:border-red-500 focus:ring-2 focus:ring-red-100 text-lg transition-all"
          />
      ...
      {status === "available" && produk && (
        <div className="p-6 bg-red-50 border-2 border-red-200 rounded-xl shadow-sm mb-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">{produk.nama_produk}</span> - {formatRupiah(produk.harga)}
              </p>
      ...
      {status === "empty" && produk && (
        <div className="p-6 bg-orange-50 border-2 border-orange-200 rounded-xl shadow-sm mb-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-orange-600">Silakan cek kembali lain waktu atau hubungi kami</p>
            </div>
          </div>
        </div>
      )}
      ...
      {status === "notfound" && (
        <div className="p-6 bg-red-100 border-2 border-red-200 rounded-xl shadow-sm mb-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-2">Kode produk yang Anda masukkan tidak terdaftar</p>
              <p className="text-sm text-red-700">Pastikan kode produk benar atau hubungi tim kami</p>
            </div>
          </div>
        </div>
      )}
      ...
      {status && (
        <div className="text-center mt-8">
          <button
            ...
            className="px-6 py-2 bg-white border-2 border-red-300 text-red-600 rounded-full font-medium hover:bg-red-50 transition-all"
          >
            Lihat Semua Produk
          </button>
        </div>
